...
export const DEFENSE = {
  ...
  wave: {
    ...
    // 2026-07-20: 26→72. "10라운드가 너무 쉽다" + 소환가 100→50(경제 2배) 보정. 초반부터 묵직하게.
    hpBase: 72,
    // 2026-07-20: 1.13→1.21. buildCap 10 난이도 상향. 시뮬(소환가 50): 숙련 r10 피크 ~33·후반 최대 75(아찔),
    //   캐주얼은 절반쯤 벽. 여전히 숙련은 8/8 클리어. ※ buildCap 50 확장 시 재조정 필수(1.21^49는 과도).
    hpPerStage: 1.21,
    hpPerIndex: 0.01,
    speed: 8,
